...
contract Student_Residence {
  ...
  function getSlice(uint256 begin, uint256 end, string memory text) private pure returns (string) {
  ...
  function getStudentFromQueueBenefits(uint _id) public view returns (uint, string, string, string, bool, string, bool) {
  ...
  function getStudentFromQueue(uint _id) public view returns (uint, string, string, string, bool, string, bool) {
    require(msg.sender == owner, "Only admin can call this method");
